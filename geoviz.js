function createTextCanvas(text, color, font, size) {
    ...
    var data = d3.csv("gps_processed.csv", function (d) {
    ...
    for (var i = 0; i < pointCount; i ++) {
        ...
        pointGeo.colors.push(new THREE.Color().setRGB(
          hexToRgb(colour(unfiltered[i].index)).r / 255, hexToRgb(colour(unfiltered[i].index)).g / 255, hexToRgb(colour(unfiltered[i].index)).b / 255 
        ));
